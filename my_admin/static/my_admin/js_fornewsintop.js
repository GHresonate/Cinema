...
for (let x=0; x<allPhotos; x++){
    ...
    if (smallBatt[preload_img].children.length<=7){
        for (let x=0; x<4; x++){
        ...
        deletedCheckboxes[preload_img] = boxes[preload_img].children[1].children[1].children[2]
       boxes[preload_img].children[1].children[1].children[2].style.display = "none"
        smallRem[x].style.top = "-175px"
        preload_img++;
    };
};
